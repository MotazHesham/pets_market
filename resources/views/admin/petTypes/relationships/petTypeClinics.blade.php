...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-petTypeClinics">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($clinics as $key => $clinic)
                        <tr data-entry-id="{{ $clinic->id }}">
                            ...
                            <td>
                                @foreach($clinic->pet_types as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-petTypeClinics:not(.ajaxTable)').DataTable({ buttons: dtButtons })
