    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_details') ? 'is-invalid' : '' }}" name="short_details" id="short_details" required>{{ old('short_details') }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('attributes') ? 'is-invalid' : '' }}" name="attributes" id="attributes">
                    ...
                    @foreach(App\Models\Product::ATTRIBUTES_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('attributes', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('attribute_options') ? 'is-invalid' : '' }}" name="attribute_options" id="attribute_options">{{ old('attribute_options') }}</textarea>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('colors') ? 'is-invalid' : '' }}" name="colors" id="colors">
                    ...
                    @foreach(App\Models\Product::COLORS_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('colors', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('featured') ? 'is-invalid' : '' }}">
                    <input class="form-check-input" type="checkbox" name="featured" id="featured" value="1" required {{ old('featured', 0) == 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('current_stock') ? 'is-invalid' : '' }}" type="number" name="current_stock" id="current_stock" value="{{ old('current_stock', '0') }}" step="1" required>
