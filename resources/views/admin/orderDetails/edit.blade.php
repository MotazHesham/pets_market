    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.order-details.update", [$orderDetail->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('variation') ? 'is-invalid' : '' }}" type="text" name="variation" id="variation" value="{{ old('variation', $orderDetail->variation) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_cost') ? 'is-invalid' : '' }}" type="number" name="total_cost" id="total_cost" value="{{ old('total_cost', $orderDetail->total_cost) }}" step="0.01" required>
