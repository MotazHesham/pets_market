    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('googleplus') ? 'is-invalid' : '' }}" type="text" name="googleplus" id="googleplus" value="{{ old('googleplus', $setting->googleplus) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description_2') ? 'is-invalid' : '' }}" name="description_2" id="description_2">{{ old('description_2', $setting->description_2) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('count_stores') ? 'is-invalid' : '' }}" type="text" name="count_stores" id="count_stores" value="{{ old('count_stores', $setting->count_stores) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('count_pets') ? 'is-invalid' : '' }}" type="text" name="count_pets" id="count_pets" value="{{ old('count_pets', $setting->count_pets) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('count_tweets') ? 'is-invalid' : '' }}" type="text" name="count_tweets" id="count_tweets" value="{{ old('count_tweets', $setting->count_tweets) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('count_products') ? 'is-invalid' : '' }}" type="text" name="count_products" id="count_products" value="{{ old('count_products', $setting->count_products) }}">
