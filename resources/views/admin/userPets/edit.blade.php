    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.user-pets.update", [$userPet->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="name">{{ trans('cruds.userPet.fields.name') }}</label>
                <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}" type="text" name="name" id="name" value="{{ old('name', $userPet->name) }}">
                @if($errors->has('name'))
            ...
            <div class="form-group">
                <label for="dob">{{ trans('cruds.userPet.fields.dob') }}</label>
                <input class="form-control date {{ $errors->has('dob') ? 'is-invalid' : '' }}" type="text" name="dob" id="dob" value="{{ old('dob', $userPet->dob) }}">
                @if($errors->has('dob'))
                    <div class="invalid-feedback">
                        {{ $errors->first('dob') }}
                    </div>
            ...
            <div class="form-group">
                <label for="pet_type_id">{{ trans('cruds.userPet.fields.pet_type') }}</label>
            ...
            <div class="form-group">
                <label for="user_id">{{ trans('cruds.userPet.fields.user') }}</label>
