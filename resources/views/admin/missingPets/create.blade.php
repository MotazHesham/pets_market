...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.missingPet.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.missing-pets.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('missing_date') ? 'is-invalid' : '' }}" type="text" name="missing_date" id="missing_date" value="{{ old('missing_date') }}">
